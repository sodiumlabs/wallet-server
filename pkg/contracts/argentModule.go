...
// MultiCallWithGuardiansAndStartSession is a paid mutator transaction binding the contract method 0x2437b75c.
//
// Solidity: function multiCallWithGuardiansAndStartSession(address _wallet, (address,uint256,bytes)[] _transactions, address _sessionUser, uint64 _duration) returns(bytes[])
func (_ArgentModule *ArgentModuleTransactor) MultiCallWithGuardiansAndStartSession(opts *bind.TransactOpts, _wallet common.Address, _transactions []TransactionManagerCall, _sessionUser common.Address, _duration uint64) (*types.Transaction, error) {
	return _ArgentModule.contract.Transact(opts, "multiCallWithGuardiansAndStartSession", _wallet, _transactions, _sessionUser, _duration)
}

// MultiCallWithGuardiansAndStartSession is a paid mutator transaction binding the contract method 0x2437b75c.
//
// Solidity: function multiCallWithGuardiansAndStartSession(address _wallet, (address,uint256,bytes)[] _transactions, address _sessionUser, uint64 _duration) returns(bytes[])
func (_ArgentModule *ArgentModuleSession) MultiCallWithGuardiansAndStartSession(_wallet common.Address, _transactions []TransactionManagerCall, _sessionUser common.Address, _duration uint64) (*types.Transaction, error) {
	return _ArgentModule.Contract.MultiCallWithGuardiansAndStartSession(&_ArgentModule.TransactOpts, _wallet, _transactions, _sessionUser, _duration)
}

// MultiCallWithGuardiansAndStartSession is a paid mutator transaction binding the contract method 0x2437b75c.
//
// Solidity: function multiCallWithGuardiansAndStartSession(address _wallet, (address,uint256,bytes)[] _transactions, address _sessionUser, uint64 _duration) returns(bytes[])
func (_ArgentModule *ArgentModuleTransactorSession) MultiCallWithGuardiansAndStartSession(_wallet common.Address, _transactions []TransactionManagerCall, _sessionUser common.Address, _duration uint64) (*types.Transaction, error) {
	return _ArgentModule.Contract.MultiCallWithGuardiansAndStartSession(&_ArgentModule.TransactOpts, _wallet, _transactions, _sessionUser, _duration)
}

// MultiCallWithSession is a paid mutator transaction binding the contract method 0x6ff6ec7c.
//
// Solidity: function multiCallWithSession(address _wallet, (address,uint256,bytes)[] _transactions) returns(bytes[])
func (_ArgentModule *ArgentModuleTransactor) MultiCallWithSession(opts *bind.TransactOpts, _wallet common.Address, _transactions []TransactionManagerCall) (*types.Transaction, error) {
	return _ArgentModule.contract.Transact(opts, "multiCallWithSession", _wallet, _transactions)
}

// MultiCallWithSession is a paid mutator transaction binding the contract method 0x6ff6ec7c.
//
// Solidity: function multiCallWithSession(address _wallet, (address,uint256,bytes)[] _transactions) returns(bytes[])
func (_ArgentModule *ArgentModuleSession) MultiCallWithSession(_wallet common.Address, _transactions []TransactionManagerCall) (*types.Transaction, error) {
	return _ArgentModule.Contract.MultiCallWithSession(&_ArgentModule.TransactOpts, _wallet, _transactions)
}

// MultiCallWithSession is a paid mutator transaction binding the contract method 0x6ff6ec7c.
//
// Solidity: function multiCallWithSession(address _wallet, (address,uint256,bytes)[] _transactions) returns(bytes[])
func (_ArgentModule *ArgentModuleTransactorSession) MultiCallWithSession(_wallet common.Address, _transactions []TransactionManagerCall) (*types.Transaction, error) {
	return _ArgentModule.Contract.MultiCallWithSession(&_ArgentModule.TransactOpts, _wallet, _transactions)
}
